...
const test = base.loadConfig().register('rootHelp', rootHelp)

describe('formatRoot', () => {
  test.rootHelp().it('renders the root help', (ctx) =>
    expect(ctx.commandHelp).to.equal(`base library for oclif CLIs

...
describe('formatHelp', () => {
  test
    ...
    .it('shows topic output', (ctx) =>
      expect(ctx.commandHelp).to.equal(`this is a description of my topic
...
`),
  ...
  test
    ...
    .it('shows topic without a description', (ctx) =>
...
`),
  ...
  test
    ...
    .it('shows topic descriptions split from \\n for top-level and description section descriptions', (ctx) =>
      expect(ctx.commandHelp).to.equal(`This is the top level description
...
`),
  ...
  test
    ...
    .it('shows topic descriptions split from \\n for top-level and description section descriptions', (ctx) =>
      expect(ctx.commandHelp).to.equal(`oclif: This is the top level description

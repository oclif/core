...
export async function parse<TFlags extends OutputFlags<any>, GFlags extends OutputFlags<any>, TArgs extends OutputArgs>(argv: string[], options: Input<TFlags, GFlags>): Promise<ParserOutput<TFlags, GFlags, TArgs>> {
  const input = {
    argv,
